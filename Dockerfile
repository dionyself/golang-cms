...
RUN cd /app/golang-cms && go get github.com/beego/bee/v2 && sleep 3
RUN cd /app/golang-cms && go install github.com/beego/bee/v2 && sleep 3
RUN cd /app/golang-cms && go mod tidy
