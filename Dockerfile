...
RUN cd /app/golang-cms && GOMAXPROCS=1 go get github.com/smartystreets/goconvey && sleep 3
RUN cd /app/golang-cms && GOMAXPROCS=1 go install github.com/smartystreets/goconvey && sleep 3
